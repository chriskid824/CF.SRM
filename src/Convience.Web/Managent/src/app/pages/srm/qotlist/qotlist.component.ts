...
export class QotlistComponent implements OnInit {
  ...
  constructor(
    ...
    this.columnDefs = [
      ...
      { headerName: '狀態', field: 'VStatusDesc', resizable: true },
    ...
    this.detailCellRendererParams = {
      detailGridOptions: {
        columnDefs: [
          ...
          { headerName: "QVendorId", field: 'QVendorId', hide: "true", resizable: true },
          { headerName: "QRfqId", field: 'QRfqId', hide: "true", resizable: true },
          { headerName: "QQotId", field: 'QQotId', hide: "true", resizable: true },
          { headerName: "序號", valueGetter: "node.rowIndex + 1", resizable: true, minWidth: 80 },
          { headerName: '報價單號', field: 'QQotNum', resizable: true, minWidth: 130 },
          { headerName: '狀態', field: 'QStatusDesc', minWidth: 80, resizable: true },
          { headerName: '料號', field: 'QMatnr', resizable: true, minWidth: 130 },
          { headerName: '建立日期', field: 'QCreateDate', valueFormatter: dateFormatter, resizable: true, minWidth: 150 },
          { headerName: '建立人員', field: 'QCreateBy', resizable: true, minWidth: 150 },
          { headerName: '最後異動日期', field: 'QLastUpdateDate', valueFormatter: dateFormatter, resizable: true, minWidth: 150 },
          { headerName: '最後異動人員', field: 'QLastUpdateBy', resizable: true, minWidth: 150 },
        ],
        defaultColDef: {
          flex: 1,
        },
